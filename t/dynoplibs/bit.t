...
.sub bands_u
    ...
    $P0 = box utf8:"hello"
    $P1 = bands $P0, $S1
    is( $P1, "hallo", 'bands utf8') #, todo => 'GH #848' )

    $S0 = utf16:"hello"
    $S1 = ucs4:"oaooo"
    $S1 = bands $S0, $S1
    is( $S1, "hallo", 'bands ucs4') #, todo => 'GH #848' )
.end
...
.sub bors_u
    ...
    $P0 = box utf8:"hello"
    $P1 = bors $P0, $S1
    is( $P1, "oeooo", 'bors utf8') #, todo => 'GH #848' )

    $P0 = box ucs4:"hello"
    $P1 = bors $P0, $S1
    is( $P1, "oaooo", 'bors ucs4') #, todo => 'GH #848' )
.end
...
.sub bxors_u
    ...
    $P0 = box utf8:"a2c"
    $P1 = bxors $P0, $S1
    is( $P1, "%Ec", 'bxors utf8') #, todo => 'GH #848' )

    $S0 = ucs4:"\u002c"
    $S2 = bxors $S1, $S0
    is( $S2, "hw", 'bxors ucs4') #, todo => 'GH #848' )
.end
